...
/*******************************************************************/
$revisa = $db->consulta("Select a.codigo,a.descripcion,e.cantidad,a.fecha_cad from articulos a, articulos e where e.codigostock>0 and a.fecha_cad<='$nueva_fecha' and a.codigo=e.codigo");
