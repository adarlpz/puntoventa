...
<body style="background-image: url(../../css/imgs/user-register.jpg);" class="programa_body box-preset">
    <center>
        <div class="cuadrado_fail">
            <p class="titulo_del_login">Usuario Creado</p>
            <p class="olvidaste_text">El Usuario Se Ha Creado Correctamente, Ahora Puedes Iniciar Sesion.</p> <img src="../../docs/correct-icon.svg" width="50px" height="50px" alt="">
