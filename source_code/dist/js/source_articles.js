...
function alta_articulo() {
    ...
    if (codigo == "" || descripcion == "" || proveedor == "" || linea == "" || linea == "0") {
        window.location = "http://localhost/electron-products-test-master/src/views/article-add-error.php";
    }
    $.ajax({
        beforeSend: function() {
        ...
        success: function(x) {
            ...
            if (x == 3) {
                ...
                window.location = "http://localhost/electron-products-test-master/src/views/aticuloyaregistrado.php";
...
function busca_articulo() {
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(x) {
                if (x == 0) {
                    window.location = "http://localhost/electron-products-test-master/src/views/article-delete-error.php";
...
function busca_articulo_cambio() {
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(x) {
                if (x == 0) {
                    window.location = "http://localhost/electron-products-test-master/src/views/article-edit-error.php";
